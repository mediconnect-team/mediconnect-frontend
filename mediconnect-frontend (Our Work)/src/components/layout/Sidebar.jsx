...
export default function Sidebar({ collapsed, toggleCollapse }) {
    ...
    const menus = {
        ROLE_PATIENT: [
            ...
            { to: "/patient/medications", label: "Medication Reminders", icon: "bi-capsule" },
        ...
        ROLE_DOCTOR: [
            ...
            { to: "/doctor/prescriptions", label: "Appointments & Prescriptions", icon: "bi-capsule" },
    ...
    return (
        ...
        >
            ...
            <div className="d-flex align-items-center justify-content-between mb-4">
                ...
                <button
                    className="btn btn-sidebar-toggle btn-sm"
